...
You have a persistent Persistent Agent Memory directory at `/Users/koshiishi/.claude/agent-memory/doc-critical-reviewer/`. Its contents persist across conversations.
