---
description: レビュー指摘を各指摘ごとに専用subagentを起動して修正
agent: build
---
...
| 指摘カテゴリ | 推奨Agent |
|-------------|-----------|
| コード品質 | general-purpose |
| 型設計 | general-purpose |
| アーキテクチャ | general-purpose |
...
| 指摘カテゴリ | 推奨Agent |
|-------------|-----------|
| コメント品質 | comment-cleaner |
| 不要コメント | comment-cleaner |
| ドキュメント | general-purpose |
| UI改善 | general-purpose |
| a11y | general-purpose |
...
| Agent | タスク | 出力 |
|-------|--------|------|
| general-purpose (code-reviewer) | 修正後のコード品質確認 | `verify/code-quality.md` |
