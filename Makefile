...
install:
	...
	@mkdir -p ~/.config
	@for dir in aerospace any-script-mcp better-auth borders direnv gh gh-dash git github-copilot karabiner kitty lazygit linearmouse mise nvim sheldon sketchybar sketchybar-kainoa sketchybar-prajinkhadka yazi; do \
